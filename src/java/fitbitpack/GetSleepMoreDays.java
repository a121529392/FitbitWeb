 ...
 * @author Yang
 */
public class GetSleepMoreDays {
    public String getdata(String user, String date,String enddate) throws SQLException {
        ...
        try {
            ...
            GetSLEEPDATA hr = new GetSLEEPDATA(date);
            backjson = hr.Sendget(str);
            System.out.println("backjson");
            System.out.println(backjson);
            Fitbit_Decorder.decode_sleep(backjson,userNameValue);
        } catch (Exception ex) {
